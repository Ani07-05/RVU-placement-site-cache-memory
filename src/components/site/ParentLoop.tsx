  ...
  return (
    <section className="relative overflow-hidden bg-paper py-24 lg:py-32">
      ...
      <div className="relative mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-lg pl-7 sm:pl-8">
          {/* Bracket connecting the last stage back to the first, showing the cycle repeats */}
          <div
            aria-hidden
            className="absolute top-6 bottom-6 left-0 w-6 rounded-l-[1.5rem] border-y border-l border-dashed border-gold-500/45 sm:w-7"
          />
          <span
            aria-hidden
            className="absolute top-6 left-0 flex h-6 w-6 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-paper text-gold-800 ring-1 ring-gold-500/40"
          >
                ...
                <Reveal key={stage.title} delay={i * 90} className="relative flex gap-5">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="relative w-0.5 flex-1 bg-mist-200">
                      <span className="absolute top-1/2 left-1/2 flex h-5 w-5 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-paper text-gold-800">
          ...
          <Reveal delay={STAGES.length * 90} className="flex items-center gap-5">
            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-gold-500/15 text-gold-800 ring-1 ring-gold-500/40">
              <RefreshLoopIcon className="h-5 w-5" />
            </span>
            <p className="text-xs leading-relaxed font-semibold tracking-[0.06em] text-gold-800 uppercase">
